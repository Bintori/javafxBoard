...
public class Board {
    ...
    public void setNo(int no) { this.no = new SimpleIntegerProperty(no); }
    ...
    public SimpleStringProperty writerProperty() { return writer; }
    ...
    public SimpleStringProperty regDateProperty() { return regDate; }
    ...
    public SimpleStringProperty updDateProperty() { return updDate; }
